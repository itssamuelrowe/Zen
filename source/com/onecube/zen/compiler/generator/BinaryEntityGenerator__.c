...
void zen_BinaryEntityGenerator_onExitCompilationUnit(zen_ASTListener_t* astListener,
     ...
     *
    jtk_Array_t* entries = jtk_Array_new(constantPoolCount);
    ...
    for (i = 0; i < constantPoolCount; i++) {
        ...
        switch (entry->m_tag) {
            ...
            case ZEN_CONSTANT_POOL_TAG_LONG: {
                ...
                zen_BinaryEntityBuilder_writeConstantPoolLongEx(generator->m_builder,
...
void zen_BinaryEntityGenerator_onEnterNewExpression(zen_ASTListener_t* listener,
    zen_ASTNode_t* node) {
}

void zen_BinaryEntityGenerator_onExitNewExpression(zen_ASTListener_t* listener,
    zen_ASTNode_t* node) {
}