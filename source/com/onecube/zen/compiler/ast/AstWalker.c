...
void zen_ASTWalker_enterRule(zen_ASTListener_t* listener, zen_ASTNode_t* node) {
    ...
    switch (node->m_type) {
        ...
        case ZEN_AST_NODE_FUNCTION_ARGUMENTS: {
            listener->m_onEnterFunctionArguments(listener, node);
            break;
        }

        case ZEN_AST_NODE_MEMBER_ACCESS: {
