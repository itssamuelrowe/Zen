...
struct zen_ErrorHandler_t {
    ...
    bool m_active;
    zen_ArrayList_t* m_syntaxErrors;
    zen_ArrayList_t* m_lexicalErrors;
    zen_ArrayList_t* m_semanticErrors;
};
...
zen_ArrayList_t* zen_ErrorHandler_getLexicalErrors(zen_ErrorHandler_t* handler);
zen_ArrayList_t* zen_ErrorHandler_getSyntaxErrors(zen_ErrorHandler_t* handler);
zen_ArrayList_t* zen_ErrorHandler_getSemanticErrors(zen_ErrorHandler_t* handler);
